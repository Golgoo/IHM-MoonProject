...
QT_MOC_LITERAL(1, 10, 18), // "error_loading_file"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 13) // "error_details"

    },
    "DataModel\0error_loading_file\0\0"
    "error_details"
};
...
void DataModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->error_loading_file((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DataModel::*)(QString ) const;
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataModel::error_loading_file)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DataModel::error_loading_file(QString _t1)const
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(const_cast< DataModel *>(this), &staticMetaObject, 0, _a);
}
QT_WARNING_POP
